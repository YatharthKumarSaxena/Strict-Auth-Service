...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "deviceRateLimit" | "authLogSchema" | "adminAction"
  ...
  export type DeviceRateLimitOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "deviceID" | "attempts" | "lastAttemptAt" | "createdAt" | "updatedAt", ExtArgs["result"]["deviceRateLimit"]>
  ...
  export interface DeviceRateLimitDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `id`
     * const deviceRateLimitWithIdOnly = await prisma.deviceRateLimit.findMany({ select: { id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many DeviceRateLimits and only return the `id`
     * const deviceRateLimitWithIdOnly = await prisma.deviceRateLimit.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more DeviceRateLimits and only return the `id`
     * const deviceRateLimitWithIdOnly = await prisma.deviceRateLimit.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface DeviceRateLimitFieldRefs {
    readonly id: FieldRef<"DeviceRateLimit", 'Int'>
  ...
  export type DeviceRateLimitWhereInput = {
    ...
    id?: IntFilter<"DeviceRateLimit"> | number
  ...
  export type DeviceRateLimitScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter<"DeviceRateLimit"> | number
